...
describe('data provider', () => {
  ...
  function getItemForIndex(index) {
    const { item } = grid._dataProviderController.getEffectiveIndexInfo(index);
    return item;
  }
...
describe('wrapped grid', () => {
  ...
  describe('data-provider', () => {
    ...
    // TODO: Falls into an infinite recursion.
    it.skip('should clear loading attribute from rows when data received', () => {
      container.dataProvider = (params, callback) => {
        callback([{}]);
      };
    ...
    it.skip('should remove loading from cells part attribute when data received', () => {
      container.dataProvider = (params, callback) => {
        callback([{}]);
      };
      const row = getRows(grid.$.items)[0];
    ...
    it.skip('should clear loading attribute from rows when scrolled to previously loaded rows', () => {
      grid.pageSize = 1;
      container.dataProvider = (params, callback) => {
        if (params.page === 0) {
